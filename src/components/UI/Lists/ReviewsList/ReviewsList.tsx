...
export const ReviewsList = ({reviews}: {reviews?: IReview[]}) => {
    return (
        <div className='container mx-auto flex flex-col gap-5 mb-20'>
            ...
            <ul>
                {reviews ? reviews.map(rev => <li key={rev.id} className="flex rounded-md mb-3">
                    <div
                    ...
                    <div
                        className="flex flex-1 items-center justify-between rounded-r-md border-b border-r border-t border-gray-200 bg-white">
